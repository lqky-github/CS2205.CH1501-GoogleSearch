# CS2205.CH1501-GoogleSearch
Tìm kiếm nâng cao trong Google
Các mẹo tìm kiếm nâng cao sau đây của Google thực sự hữu ích có thể bạn chưa biết. Là một người tìm kiếm với tìm kiếm nâng cao này sẽ giúp bạn rất nhiều trong công việc, ví dụ:

    1. Xác định được từ khóa cần tránh đụng hàng với các trang đã có cần tham khảo để tạo ra Title là unique
    2. Bạn muốn biết những trang web nào đang sử dụng nội dung thông tin của mình?
    3. Những trang nào đang đặt link của mình trên trang của họ?
...
Ví dụ tìm kiếm:  "phương pháp nghiên cứu khoa học" 

# 2. Loại trừ Từ
Giả sử bạn muốn tìm kiếm nội dung về "phương pháp", nhưng bạn muốn loại trừ bất kỳ kết quả nào có chứa "nội quy" theo cụm từ. Để làm điều này, bạn chỉ cần sử dụng dấu - ở phía trước của từ mà bạn muốn loại trừ.
Ví dụ tìm kiếm:  phương pháp -nội quy
...
Ví dụ Tìm kiếm: allintext:Quy trình 
...
Tìm kiếm ví dụ: allinurl:phương pháp nghiên cứu

# 9. Cách tìm kiếm trong một trang web
Thông thường, bạn muốn tìm kiếm một trang web cụ thể cho nội dung phù hợp với cụm từ nhất định. Ngay cả khi trang web không hỗ trợ tính năng tìm kiếm, bạn có thể sử dụng Google để tìm kiếm trang web cho cụm từ của bạn. Đơn giản chỉ cần sử dụng site: uit.edu.vn. 
Ví dụ Tìm kiếm: site:uit.edu.vn "tài liệu học phương pháp nghiên cứu khoa học" 

# 10. Tìm kiếm có liên quan
Nếu bạn muốn tìm các trang web mới có nội dung tương tự với một trang web bạn đã biết, hãy sử dụng related: uit.edu.vn. Tìm những trang liên quan để xác định những trang cùng lĩnh vực để có kế hoạch SEO như tìm hiểu cách làm, liên hệ viết bài trên mục blog để xây dựng backlink.
Ví dụ tìm kiếm: related: uit.edu.vn 
